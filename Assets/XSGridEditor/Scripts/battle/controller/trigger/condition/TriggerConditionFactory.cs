namespace XSSLG
{
    ...
    public class TriggerConditionFactory
    {
        ...
        /// <returns></returns>
        public static TriggerConditionBase Create(TriggerDataTriggerType type, TriggerDataConditionStruct conditionStruct)
        {
            switch (type)
            {
                case TriggerDataTriggerType.AfterAttack: return new AfterAttackCondition(conditionStruct);

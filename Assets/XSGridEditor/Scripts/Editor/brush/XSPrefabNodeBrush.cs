...
namespace XSSLG
{
    ...
    public class XSPrefabNodeBrush : XSNodeBrushBase<XSPrefabNode>
    {
        ...
        protected override string defaultObjPath { get; } = "Assets/XSGridEditor/Resources/prefab/PrefabBrushs";
        ...
        public override void Paint(GridLayout gridLayout, GameObject brushTarget, Vector3Int position)
        {
            ...
            if (ret)
            {
                if (this.IsExistTile(gridLayout, position))
                {
                    ...
                    XSUE.GridHelperEditMode?.RemoveXSTileByWorldPos(node.WorldPos);
                }
        ...
        protected override XSINodeMgr<XSPrefabNode> GetMgr() => XSUE.PrefabNodeMgr;
    }

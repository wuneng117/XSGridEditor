...
namespace XSSLG
{
    ...
    public partial class XSU
    {
        ...
        protected static RaycastHit GetMouseHit(Vector2 screenPos, string layerName) => XSU.GetMouseHit(screenPos, layerName, XSU.GetMainCamera());

        public static RaycastHit GetMouseHit(Vector2 screenPos) => XSU.GetMouseHit(screenPos, "");
